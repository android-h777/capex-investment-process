    ...
    <div class="cpx-summary cpx-sum-reveal">
      <div class="cpx-sum-head">
        <div class="cpx-sum-head-l">
          <span class="ai-badge"><i class="material-icons">auto_awesome</i>AI Generated</span>
      ...
      <div class="cpx-sum-genline">
        <i class="material-icons">auto_awesome</i>
        Auto-generated by AI from live project data · ${c.lastMod.replace('Last Mod. ', '')} — review before circulation.
      </div>
    </div>`;
}
